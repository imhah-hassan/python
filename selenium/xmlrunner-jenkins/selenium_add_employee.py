...
class GestionEmploye(unittest.TestCase):
    ...
    def wait_for_element(self, by, locator):
        ...
        try:
            ...
            print ("Eleement not visible",by, locator)
    ...
    def test_b_change_localization(self):
        print ('test_b_change_localization')
        driver = self.driver
    ...
    def test_c_deleteAllEmployee(self):
        print ('test_c_deleteAllEmployee')
        driver = self.driver
    ...
    def test_f_delete_employee(self):
        print ('test_f_delete_employee')
        driver = self.driver
